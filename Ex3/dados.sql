...
START TRANSACTION;
USE `TrabBD7_Ex3`;
INSERT INTO `Profissao` (`idProfissao`, `nomeProfissao`) VALUES (1, 'Medico(a)');
INSERT INTO `Profissao` (`idProfissao`, `nomeProfissao`) VALUES (2 , 'Engenheiro(a)');
INSERT INTO `Profissao` (`idProfissao`, `nomeProfissao`) VALUES (3, 'Professor(a)');
...
USE TrabBD7_Ex3;
INSERT INTO Cliente (codCliente, nomeCliente, `Profissao_idProfissao`) VALUES (1, 'Leonardo', 1);
INSERT INTO Cliente (codCliente, nomeCliente, `Profissao_idProfissao`) VALUES (2, 'Bruno', 2);
INSERT INTO Cliente (codCliente, nomeCliente, `Profissao_idProfissao`) VALUES (3, 'João', 3);
INSERT INTO Cliente (codCliente, nomeCliente, `Profissao_idProfissao`) VALUES (4, 'Carlos', 1);
INSERT INTO Cliente (codCliente, nomeCliente, `Profissao_idProfissao`) VALUES (5, 'Roberto', NULL);
